...
export class DeliveryListComponent implements OnInit {
  ...
  // EditData(logdata:any){
  //   this.modalService.open(this.dialog).then((data: any)=>{
  //     console.log(logdata.id,logdata);
  //   });

    // this.modelService.EditData(id,{ariaLabel: 'model-basic-title'})
  // }
  // EditData(){

  //   this.api.UpdateData(this.updateForm.value).subscribe((res: Signup_Det)=>{
  //     // alert(JSON.stringify(res));
  //     this.matSnackBar.open("Your data updated successfully",'Okay', { duration: 4000 });
  //     this.updateForm.reset();
  //   },(err:any)=>{
  //     this.matSnackBar.open("could not process and update",'sorry', { duration: 4000 });
  //   });
  // }
  // RemoveData(){
  //   this.api.DeleteData(this.logdata.value.id)
  // }
}
